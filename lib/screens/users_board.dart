              ...
              builder: (context, usersSnapshot) {
                return ListView.builder(
                    ...
                    itemBuilder: (
                      ...
                      return _userTile(
                          usersSnapshot.data[index], currentUserSnapshot.data);
                    });
              },
            ),
          );
            ...
            onPressed: () async {
              if (currentUser != null) {
                ...
                Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => GameProcessPage()));
              } else {
                Navigator.of(context)
                    .push(MaterialPageRoute(builder: (index) => LoginScreen()));
              }
            },
          ),
          FlatButton(
  ...
  _showCantPlayDialog(User user) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text("Can't play with " +
            user.name +
            ", user is currently " +
            userUtil.getStringFromState(user.currentState)),
        actions: <Widget>[
          FlatButton(
            child: Text('OK'),
            onPressed: () async {
